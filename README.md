...
2. What is the difference between a function and a method?
   A function stands on its own, a method is a function inside an object
3. What is closure?
   closure gives you access to an outer function's scope from an inner function
4. Describe the four rules of the 'this' keyword.
   the function is called by new
   the function is called by call(), apply(), or bind()
   the function is called as a method
   the function is called in the global scope
